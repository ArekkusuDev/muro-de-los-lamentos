...
export function CardButton({ text, ...props }: ButtonProps) {
	return (
		<button
			{...props}
			className='font-creepster tracking-widest card-button relative overflow-hidden text-white border-2 border-white rounded-lg px-6 py-3 text-2xl transition duration-300 ease-in-out
